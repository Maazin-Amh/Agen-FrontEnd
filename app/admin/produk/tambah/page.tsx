...
export const ProdukCreateSchema = yup.object().shape({
  ...
  barcode: yup.string().nullable().required("isi ini"),
                    ...
                    {values &&
                      values?.data?.map((value, index) => (
                        ...
                        >
                          ...
                          <section>
                            <Label htmlFor="barcode" title="barcode" />
                            <InputText
                              value={value.barcode}
                          ...
                          <section>
                            ...
                            <CurrencyInputs
                              ...
                              touched={getIn(touched?.data?.[index], "harga")}
                              onValueChange={(value) => {
                          ...
                          <section>
                            ...
                            <CurrencyInputs
                              value={value.stok || undefined}
                              id={`data[${index}]stok`}
                              name={`data[${index}]stok`}
                              error={getIn(errors?.data?.[index], "stok")}
                              touched={getIn(touched?.data?.[index], "stok")}
                              onValueChange={(value) => {
